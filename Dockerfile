...
WORKDIR /var/www/UTSJoshua

# Salin file proyek ke container
COPY . /var/www/UTSJoshua

# Install dependensi proyek Laravel
RUN composer install --optimize-autoloader --no-dev

# Atur izin untuk folder storage dan bootstrap/cache
RUN chown -R www-data:www-data /var/www/UTSJoshua \
    && chmod -R 755 /var/www/UTSJoshua/storage \
    && chmod -R 755 /var/www/UTSJoshua/bootstrap/cache
